...
|Findings | Not for the project proposal; for final report only. Given answers to each of your research questions. (About 400 words.) |
...
|6.0 Limitations | Proposal only. What limitations might you need to address? Briefly discuss. (About 150 words.) |
